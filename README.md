...
### The App enables the users to create new tasks, by entering a task name and selecting a due date, and save them into the database. It is also possible to view a list of all tasks ordered by date, where the users can tick the tasks as "completed", edit the information or delete any item. 
